    ...
    public class EDI315MsgParsing
    {
                        ...
                        switch (header)
                        {
                            ...
                            case "GS":  // insert DB
                                ...
                                if (dbEDI315.msg_idnum != 0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        util.insetLog_TextFile("315", msg_idnum, dbEDI315.EDI315_idnum, 0, logMsg);
                            ...
                            case "SE":
                                ...
                                else
                                {
                                    ...
                                    logMsg += "Error Message: Not able to access DB. Process rollbacked.\r\n";
                                    util.insetLog_TextFile("315", msg_idnum, dbEDI315.EDI315_idnum, dbEDI315_Detail.EDI315_Detail_idnum, logMsg);
        ...
        public void rollbackProcess(int msg_idnum)
        {
            if (msg_idnum != 0)
            {
                ...
                {
                    string logMsg = "Function: rollbackProcess - Table EDI315_Detail, EDI315_Detail_N9, EDI315_Detail_R4, EDI315_Detail_R4_DTM\r\n";
                    logMsg += "Error Message: Not able to access DB. Process rollbacked.\r\n";
                    util.insetLog_TextFile("315", msg_idnum, dbEDI315.EDI315_idnum, dbEDI315_Detail.EDI315_Detail_idnum, logMsg);
