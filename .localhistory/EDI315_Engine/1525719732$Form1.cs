...
namespace EDI315_Engine
{
    public partial class mainForm : Form
    {
        ...
        private BackgroundWorker _bgwBtn = null;
        ...
        private void btn_Start_Click(object sender, EventArgs e)
        {
            ...
            if (btn_Start.Text == "START")
            {
                ...
                _bgwBtn = new BackgroundWorker();
                _bgwBtn.WorkerSupportsCancellation = true;
                _bgwBtn.DoWork += new DoWorkEventHandler((state, arge) =>
                {
                    do
                    {
                        if (_bgwBtn.CancellationPending)
                            break;

                        timer_mainTimer.Start();
                    } while (true);
                });
                _bgwBtn.RunWorkerAsync();
