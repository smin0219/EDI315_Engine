                            ...
                            case "GS":
                                ...
                                using (DBContext context = new DBContext())
                                {
                                    ...
                                    EDI315 dbEDI315 = new EDI315()
                                    {
                                        ...
                                        GS_functional_id_code = GS_functional_id_code,
                                        GS_app_sender_code = GS_app_sender_code,
                                        GS_app_receiver_code = GS_app_receiver_code,
                                        GS_date = GS_date,
                                        GS_time = GS_time,
                                        GS_group_control_number = GS_group_control_number,
                                        GS_reponsible_agency_code = GS_reponsible_agency_code,
                                        GS_industry_id_code = GS_industry_id_code
