...
namespace EDI315_Engine.Service
{
    public class EDI315MsgParsing
    {
        ...
        protected int tempConvertToInt = 0;
                    ...
                    if(row != null && row.Count() > 0)
                    {
                        ...
                        switch (header)
                        {
                            ...
                            case "Q2":
                                ...
                                tempConvertToInt = 0;
                                if (rowLine[6] != null && rowLine[6].Trim() != string.Empty && Int32.TryParse(rowLine[6], out tempConvertToInt))
                                    dbEDI315_Detail.Q2_lading_quantity = tempConvertToInt;
