                    ...
                    if (row != null && row.Count() > 0)
                    {
                        ...
                        switch (header)
                        {
                            ...
                            case "R4":
                                ...
                                if (rowLine.Count() > 3)
                                    dbTempR4.free_form_description = rowLine[3];

                                if (rowLine.Count() > 4)
                                    dbTempR4.free_form_description = rowLine[4];

                                if (rowLine.Count() > 5)
                                    dbTempR4.date = rowLine[5];

                                if (rowLine.Count() > 6)
                                    dbTempR4.time = rowLine[6];

                                if (rowLine.Count() > 7)
                                    dbTempR4.time_code = rowLine[7];
