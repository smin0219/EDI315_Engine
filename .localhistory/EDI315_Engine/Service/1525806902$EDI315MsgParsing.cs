                                ...
                                if (dbConnectionCheck())
                                {
                                    using (DBContext context = new DBContext())
                                    {
                                        ...
                                        foreach(EDI315_Detail_R4 dbR4Row in dbEDI315_Detail_R4List)
                                        {
                                            ...
                                            dtmList.ForEach(x => x.EDI315_Detail_idnum = dbEDI315_Detail.EDI315_Detail_idnum);
                                            dtmList.ForEach(x => x.EDI315_Detail_idnum == dbEDI315_Detail.EDI315_Detail_idnum && x.Detail_R4_idnum == dbR4Row.Detail_R4_idnum);
