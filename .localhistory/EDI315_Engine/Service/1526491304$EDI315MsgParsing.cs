...
namespace EDI315_Engine.Service
{
    public class EDI315MsgParsing
    {
                    ...
                    if (row != null && row.Length > 0)
                    {
                        ...
                        switch (header)
                        {
                            case "ISA":
                                ...
                                {
                                    throw new Exception("Mandatory elements are missing for ISA. ISA message line is \r\n" + row + "\r\n");
                                }
                                #endregion
                                break;
                            case "GS":  // insert DB
                                ...
                                {
                                    throw new Exception("Mandatory elements are missing for GS. GS message line is \r\n" + row + "\r\n");
                                }
                            ...
                            case "B4":
                                ...
                                {
                                    throw new Exception("Mandatory elements are missing for " + header + ". " + header +B4 message line is \r\n" + row + "\r\n");
                                }
        ...
        public void rollbackProcess(int msg_idnum, string msgType)
        {
            if (msg_idnum != 0)
            {
                if (util.dbConnectionCheck())
